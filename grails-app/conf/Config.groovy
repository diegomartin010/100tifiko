...
grails {
    ...
    mail {
         ...
         host = "smtp.gmail.com"
         port = 465
         username = "100tifiko.staff@gmail.com"
         password = "patanmp3"
...
grails.plugin.springsecurity.controllerAnnotations.staticRules = [
	'/':                ['ROLE_ADMINISTRADOR','ROLE_ALUMNO'],
	'/index':           ['ROLE_ADMINISTRADOR','ROLE_ALUMNO'],
	'/index.gsp':       ['ROLE_ADMINISTRADOR','ROLE_ALUMNO'],
	'/**':       ['permitAll'],
    // Controlador para cear usuario
