...
<body>
	...
	%{-- Estilo body de la pagina --}%
		...
		<div class="row">
            <div class="col-lg-12">
                <h1 class="page-header"><i class="fa fa-thumbs-o-up fa-fw"></i>Estado Académico</h1>
            </div>
        </div>
        %{-- ./row --}%		
        ...
        <div class="panel panel-default">
            <div class="panel-heading"><i class="fa fa-th-list"></i> <label>Estado Actual</label></div>
            <!-- /.panel-heading -->
